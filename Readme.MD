...
<b>Note:</b> You might need to save the Excel file on a local drive. Network/shared drives (e.g. OneDrive) do not allow running Excel files with macros.
<p>
<p>
...
VERSION HISTORY
---------------
Version 3.1: Added back-calcuation of IntraCV from 90%CI for 3PSR and 4PSR study designs. Fixed cancel buttons in CV back calculation routines.
